...
<form action="<?php echo site_url('/login/create_member') ?>" method="post" accept-charset="utf-8">
    ...
    请选择答案以获得个人评分。（评分将决定遇到的对手的强度，请慎重填写）
    <br>1. 惯用的拍子磅数（如果知道横竖线的区别，则以（横线+竖线）/2为准）<br>
    <select name="q1">
    ...
    <br>4. 体能问题，请你计算时间，在一分钟内做多的尽量仰卧起坐，并输入数量<br>
    ...
    <br>7. 后退步法问题：在对手的高远球越过我的头顶的情况下，我<br>
    <select name="q7">
    ...
    <br>10. 发高远球问题:我站在己方场地中间，想在开球时发远球<br>
    <select name="q10">
